      ...
      <div class="qrcode-body body">
        ...
        <div class="qrcode-line line">
          <div class="qrcode-qrcode qrcode">
            <img id="qr-code" alt="image" src="aba.png"
              class="qrcode-qr" />
...
const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7ImlkIjoiZmIwM2JmY2E3MjBiNDAxZSJ9LCJpYXQiOjE3NDMyMzc3OTQsImV4cCI6MTc1MTAxMzc5NH0.fi6ljrs4fr0Xgn_-rTZJ_T-90Tfu0W428IjWgECh1VQ'; // Replace with your actual token
